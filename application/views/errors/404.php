<head>
    ...
    <link rel="stylesheet" href="/public/styles/error404.css">
    <title>404</title>
</head>
<div class="container">
    <div class="row">
        ...
        <div class="content col-12">
            ...
            <main class="spinner">
                ...
                <svg class="svg" width="125" height="125" viewBox="-5 -5 100 100" version="1.1" baseProfil="full"
        ...
        <div class="button col-12">
            <a class="btn" href="/" role="button">На главную</a>
        </div>
    </div>
</div>
